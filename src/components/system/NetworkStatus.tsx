...
const NetworkStatus = () => {
  ...
  const [connection, setConnection] = useState<NetworkInformation | undefined>(
    () => getConnection(),
  );
  ...
  const networkState = useMemo(() => {
    if (!isOnline) {
      return {
        ...
        message:
          "Playback and uploads may pause until your connection returns.",
      };
    }
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-center gap-3 text-center">
        ...
        <div className="min-w-0">
          ...
          <Typography
            ...
            className={cn(
              "ml-2 inline",
              isRecovered ? "text-white/85" : "text-black/70",
            )}
          >
            {status.message}
          </Typography>
